...
gaya1 = setting.gaya1
gaya2 = setting.gaya2
const fakeimage = fs.readFileSync ('./media/TextPro.me_16224657a4dd51.jpg')
const thumb = fs.readFileSync ('./media/TextPro.me_16224657a4dd51.jpg')
...
const textImg = (teks) => { return Dhani.sendMessage(from, teks, text, {quoted: fgi, thumbnail: fs.readFileSync('./media/TextPro.me_16224657a4dd51.jpg')})}
